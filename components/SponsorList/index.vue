<template>
  <div>
    ...
    <p class="text-center opacity-50">
      &copy; Official website Pemerintah Provinsi Jawa Barat 2020
    </p>
  </div>
</template>
