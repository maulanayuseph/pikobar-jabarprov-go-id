      ...
      <table class="table w-full border-t border-solid border-gray-300 tableFixHead" :class="isLoading?'hidden':''">
        <thead class="select-none">
          <tr>
            ...
            <th colspan="3" class="px-2 py-1 hover:opacity-75 text-white  bg-color-blue">
              ODP Proses
            </th>
          ...
          <tr>
            ...
            <th
              :key="3"
              ref="tableHeaders"
              class="px-2 py-1 hover:opacity-75 text-white bg-color-blue-dark"
              style="padding-left: 0.5em !important; width: 7%;"
...
export default {
  ...
  watch: {
    ...
    dataSebaranPertumbuhan (val) {
      ...
      val.forEach((element) => {
        // total
        total.suspectNow += element.odp.odp_total_h1
        total.suspectAverage += element.odp.odp_total_h7
        total.suspectTotal += element.odp.odp_total
        total.processNow += element.odp.odp_aktif_h1
        total.processAverage += element.odp.odp_aktif_h7
        total.processTotal += element.odp.odp_aktif
        total.finishedNow += element.odp.odp_selesai_h1
        total.finishedAverage += element.odp.odp_selesai_h7
        ...
        dataCase.push({
          ...
          suspectNow: element.odp.odp_total_h1,
          suspectAverage: element.odp.odp_total_h7,
          suspectTotal: element.odp.odp_total,
          processNow: element.odp.odp_aktif_h1,
          processAverage: element.odp.odp_aktif_h7,
          processTotal: element.odp.odp_aktif,
          finishedNow: element.odp.odp_selesai_h1,
          finishedAverage: element.odp.odp_selesai_h7,
          finishedTotal: element.odp.odp_selesai,
          diedNow: element.odp.odp_meninggal_h1,
          diedAverage: element.odp.odp_meninggal_h7,
          diedTotal: element.odp.odp_meninggal
        })
      })
