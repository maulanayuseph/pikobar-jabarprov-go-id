...
export default {
  name: 'ConfirmedCaseListIstilahBaru',
  components: {
    ContentLoader
  },
  props: {
  ...
  watch: {
    ...
    dataSebaranPertumbuhan (val) {
      ...
      val.forEach((element) => {
        // total
        total.confirmedNow += element.confirmation.confirmation_total_h1
        total.confirmedAverage += element.confirmation.confirmation_total_h7
        total.confirmedTotal += element.confirmation.confirmation_total
        total.positiveNow += element.confirmation.confirmation_diisolasi_h1
        total.positiveAverage += element.confirmation.confirmation_diisolasi_h7
        total.positiveTotal += element.confirmation.confirmation_diisolasi
        total.recoverNow += element.confirmation.confirmation_selesai_h1
        total.recoverAverage += element.confirmation.confirmation_selesai_h7
        total.recoverTotal += element.confirmation.confirmation_selesai
        total.dieNow += element.confirmation.confirmation_meninggal_h1
        total.dieAverage += element.confirmation.confirmation_meninggal_h7
        total.dieTotal += element.confirmation.confirmation_meninggal

        // data table
        dataCase.push({
          region: element[nameApiRegion],
          confirmedNow: element.confirmation.confirmation_total_h1,
          confirmedAverage: element.confirmation.confirmation_total_h7,
          confirmedTotal: element.confirmation.confirmation_total,
          positiveNow: element.confirmation.confirmation_diisolasi_h1,
          positiveAverage: element.confirmation.confirmation_diisolasi_h7,
          positiveTotal: element.confirmation.confirmation_diisolasi,
          recoverNow: element.confirmation.confirmation_selesai_h1,
          recoverAverage: element.confirmation.confirmation_selesai_h7,
          recoverTotal: element.confirmation.confirmation_selesai,
          dieNow: element.confirmation.confirmation_meninggal_h1,
          dieAverage: element.confirmation.confirmation_meninggal_h7,
          dieTotal: element.confirmation.confirmation_meninggal
        })
      })
