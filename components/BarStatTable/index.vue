...
export default {
  ...
  methods: {
    ...
    groupingKota () {
      const rangeTotalSampai = this.temporary.length - 1
      ...
      const rangeH7Sampai = this.temporary.length - (7 * 27) - 1
      const rangeH7Dari = this.temporary.length - (8 * 27)
